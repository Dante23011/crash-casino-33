...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-f00fd607');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-f00fd607');}
...
function clearFlash(){dieView.classList.remove('rl-win-f00fd607');dieView.classList.remove('rl-lose-f00fd607');if(frameEl){frameEl.classList.remove('rl-win-f00fd607');frameEl.classList.remove('rl-lose-f00fd607');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-f00fd607');if(frameEl){frameEl.classList.add('rl-win-f00fd607');}}else{dieView.classList.add('rl-lose-f00fd607');if(frameEl){frameEl.classList.add('rl-lose-f00fd607');}}
...
var brandEl=document.querySelector('.rl-brand-f00fd607');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
